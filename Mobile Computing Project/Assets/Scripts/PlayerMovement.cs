...
public class PlayerMovement2 : MonoBehaviour
{
    ...
    void Update() 
    {
        ...
        //SWITCH LINES TO GO BACK TO MOBILE CONTROLS
        ...
        //SWITCH IF LINE TO GO BACK TO MOBILE CONTROLS
    ...
    private void UpdateAnimation()
    {
        ...
        {
            animationSpeed = (rb.velocity.magnitude) / moveValue;

            animator.SetFloat("speedMultiplier", Mathf.Clamp(animationSpeed, 0.5f, 1.5f));
